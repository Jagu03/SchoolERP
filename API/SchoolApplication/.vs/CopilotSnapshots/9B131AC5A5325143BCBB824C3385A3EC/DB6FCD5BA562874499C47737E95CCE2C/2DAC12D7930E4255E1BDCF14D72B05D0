...
namespace SchoolAPI.Controllers
{
    ...
    [Authorize]
    public class ClassSectionAllocationController : ControllerBase
    {
        ...
        public async Task<IActionResult> MergeAllocateClassSection([FromBody] ClassSectionAllocation classSectionAllocation)
        {
            ...
            try
            {
                ...
                {
                    StatusCode = 200,
                    Message = "Class section allocation processed successfully.",
                    Data = result
                });
            }
        ...
        public async Task<IActionResult> FetchClassSectionAllocations([FromQuery] short acadYearId)
        {
            if (acadYearId <= 0)
            {
                ...
                {
                    StatusCode = 400,
                    Message = "AcadYearId query parameter is required and must be greater than 0."
                });
            }
